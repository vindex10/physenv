...
BUILD_DIR="$BUILD_DIR" ROOT_BUILD_DIR="$root_build_dir" $SCRIPTS_DIR/packages/hepmc.sh build
...
BUILD_DIR="$BUILD_DIR" ROOT_BUILD_DIR="$root_build_dir" HEPMC_BUILD_DIR="$hepmc_build_dir" LHAPDF6_BUILD_DIR="$lhapdf6_build_dir" $SCRIPTS_DIR/packages/pythia8.sh build
