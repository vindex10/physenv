...
export LD_LIBDRARY_PATH="$root_build_dir/lib:$hepmc_build_dir/lib:$lhapdf6_build_dir/lib:$pythia8_build_dir/lib:$yoda_build_dir/lib:$fastjet_build_dir/lib:$rivet_build_dir/lib:$sherpa_build_dir/lib/SHERPA-MC:$LD_LIBDRARY_PATH"

export PATH="$root_build_dir/bin:$hepmc_build_dir/bin:$lhapdf6_build_dir/vin:$pythia8_build_dir/bin:$yoda_build_dir/bin:$fastjet_build_dir/bin:$rivet_build_dir/bin:$sherpa_build_dir/bin:$PATH"
